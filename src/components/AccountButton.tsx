...
export default function AccountButton({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 bottom-full mb-2 lg:bottom-auto lg:top-full lg:mt-2 lg:mb-0 z-50 min-w-[200px] bg-white border border-luxe-line rounded-sm shadow-soft overflow-hidden">
          {email ? (
            <>
